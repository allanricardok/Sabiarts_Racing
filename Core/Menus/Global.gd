...
# REMOVIDO: points_to_next_city saiu daqui. Cada mapa agora define seu
# próprio requisito diretamente no Inspector do StoryNextMapPortal.gd.
...
# =====================================================================
# NOVO: chave de teleporte precisa sobreviver entre runs, então mora aqui
# (persistida em disco junto com o resto do progresso de história) em vez
# de só existir como propriedade solta no carro, que reseta a cada run.
var has_teleport_key: bool = false
# =====================================================================
...
func save_story_progress():
	...
	file.set_value("Story", "has_teleport_key", has_teleport_key) # NOVO
...
func load_story_progress():
	...
	if file.load("user://story_progress.cfg") == OK:
		...
		has_teleport_key = file.get_value("Story", "has_teleport_key", false) # NOVO
